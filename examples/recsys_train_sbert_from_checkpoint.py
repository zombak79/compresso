...
from recsys_lib.checkpoint import SBERT_DIR, load_recsys_split, save_json, update_checkpoint, update_stage_manifest
...
def main():
    ...
    try:
        ...
        raise ImportError(
            ...
            "`pip install sentence-transformers` or `pip install -e .[semantic]`."
        ) from e
